...
<div class="wrapper">
  ...
  <div class="main-panel" data-color="blue">
    ...
    <div class="content">
      <div class="row">
        <div class="col-md-12">
          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addemployees">Add</button>
          <!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="addemployeesLabel">Add an employees</h5>
                  ...
                  <div class="row">
                    ...
                    <div class="col-6" style="padding-left: 0px;">
                      <div class="form-group">
                        <input type="text" class="form-control text-dark" placeholder="Surname">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control datetimepicker text-dark " value="10/05/2018"/>
                      </div>
                    </div>
                  </div>
                </div>
